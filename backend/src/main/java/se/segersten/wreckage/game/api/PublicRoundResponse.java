...
public record PublicRoundResponse(int number, RoundPhase phase, Map<UUID,Boolean> ready, List<VehicleResponse> initialVehicles, List<RoundEventResponse> playback) {
