...
export type RoundEvent = { sequence: number; type: 'MOVE' | 'TURN' | 'RAM' | 'PUSH'; playerId: string; vehicleId: string; oldPosition: Position; newPosition: Position; oldDirection: Direction; newDirection: Direction }
